...
{ title: "Fake person to help you escape Le Wagon's livecode",
  description: "Can't be bothered to go to Le Wagon's livecode and scared the little drum is going to pick you? HAVE NO FEAR, Carl is your sick friend that just got an accident and is at the hospital! You need to visit him, he might die. Don't wait one second more, and BOOK CARL TODAY.",
  price: 200,
  category: "Education",
  user: User.all.sample
},
...
{ title: "Fake grandma faking her death to get you out of work",
...
{ title: "Fake priest faking your religious conversion to get married",
  description: "You're jewish but you want to get married to the man of your dream? He's a catholic and his parents won't have you marry him if you don't convert? HAVE NO FEAR, Priest Jean will convince them that you converted and are a good catholic now and thus you will be able to marry your beloved prince. BOOK PRIEST JEAN TODAY.",
  price: 440,
  category: "Relationship",
  user: User.all.sample
},
...
{ title: "Fake friend pretending to have a nervous breakdown to escape a family weekend",
  description: "Your annual family weekend approaches and no you don't want to know how your cousins are happy in their new marriages or hear one more time uncle Ted's stupid jokes. HAVE NO FEAR. JULIA is here to call you you, cry, scream and promise she will kill herself if you don't come take care of her right away (Julia is slightly dramatic). BOOK JULIA TODAY.",
  price: 500,
  category: "Family",
  user: User.all.sample
},
{ title: "Fake bridesmaids to ruin your wedding so you don't have to marry that loser",
  description: " You just realised que you rushed into Bernard's proposition to get married. You were scared (and propably drunk) when you said yes. Don't worry! ANA, CLAUDIA, JANET AND LILA  will make you have an unforgettable wedding and will totally ruin the ceremony. Shame, now you are traumatised for life and don't want to get married anymore. Damn. BOOK THEM TODAY",
  price: 1500,
  category: "Relationship",
  user: User.all.sample
},
{ title: "Fake hippie pretending that this joint didn't belong to you",
  description: "Your parents saw a few joints in your room and you're now grounded for a year? Not to worry, your friend LEILA is going to pay you a visit and get back the stack of joints that you nicely kept for her. She will apologise to you and to your parents for all the trouble caused. Really, they shouldn't blame you, it was all her fault. BOOK LEILA TODAY.",
  price: 120,
  category: "Family",
  user: User.all.sample
},
...
{ title: "Fake grandpa pretending to take you to a tchatcha class",
  description: "You're always skipping this monday 9 AM class and your teacher is angry and threatens you to lower your grade. Well there is a simple explanation. Robert, your grandpa is taking you to his tchatcha class. You can never spend time with him because he's at the hospital most of the time but his only activity out is this monday tchatcha class and not to go with him would break his heart. Your teacher surely can understand that. BOOK ROBERT TODAY.",
  price: 170,
  category: "Education",
  user: User.all.sample
},
{ title: "Fake woman pretending you have been selected to do a free world tour and must leave immediatly",
  description: "You wish you had a different life and want to say f*** to everything? Well Danaerys will take you to another world. Indeed, you've been selected by this program to do a world tour and must leave immediatly - how can you refuse such an opportunity? It will allow you to start fresh. BOOK DAENERYS TODAY.",
  price: 590,
  category: "Work",
  user: User.all.sample
},
{ title: "Fake man pretending the tickets to Tomorrowland your wife saw were not yours",
  description: "Your wife doesn't understand why your voice is broken and she found tickets to Tomorrowland on your phone? (HUNNY - HOW COULD YOU? YOU SAID IT WAS A BUSINESS TRIP!!). Not to worry. DAN is here. Dan is the intern in your office and as a nice colleague you proposed to book his ticket to Tomorrowland so his parents wouldn't find out he went. BOOK DAN TODAY.",
  price: 720,
  category: "Work",
  user: User.all.sample
},
{ title: "Fake woman pretending that you saved her life while she drowned",
  description: " You don't want to go that business retreat with your colleagues? DAMN you missed the flight because you're a hero! Yes you saved the life of that women drowning in a pool and now she's between life or death so you have to stay in the hospital with her, as any good human being would. BOOK TANIA TODAY.",
  price: 600,
  category: "Work",
  user: User.all.sample
}
